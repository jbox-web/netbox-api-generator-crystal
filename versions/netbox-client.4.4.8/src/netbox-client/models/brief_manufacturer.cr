...
module NetboxClient
  ...
  class BriefManufacturer
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @devicetype_count : Int64, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, slug, description, devicetype_count].hash
    end
    ...
    def to_h
      ...
      hash["devicetype_count"] = _to_h(devicetype_count)
      hash.to_h
    end
