...
module NetboxClient
  ...
  class BriefDeviceType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @manufacturer : BriefManufacturer, @model : String, @slug : String, @device_count : Int64, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, manufacturer, model, slug, description, device_count].hash
    end
