...
module NetboxClient
  ...
  class BriefPowerPanel
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @powerfeed_count : Int64, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, description, powerfeed_count].hash
    end
