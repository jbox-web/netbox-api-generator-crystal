...
module NetboxClient
  ...
  class BriefRack
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @device_count : Int64, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, description, device_count].hash
    end
