...
module NetboxClient
  ...
  class BriefCluster
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @virtualmachine_count : Int64, @description : String? = nil)
    end
    ...
    def hash
      [id, url, display, name, description, virtualmachine_count].hash
    end
