...
module NetboxClient
  ...
  class RackReservationRequest
    ...
    # Required properties
    @[JSON::Field(key: "rack", type: PatchedWritableRackReservationRequestRack, nillable: false, emit_null: false)]
    property rack : PatchedWritableRackReservationRequestRack

    @[JSON::Field(key: "units", type: Array(Int32), nillable: false, emit_null: false)]
    ...
    def initialize(@rack : PatchedWritableRackReservationRequestRack, @units : Array(Int32), @user : BookmarkRequestUser, @description : String, @status : String? = nil, @tenant : AsnRangeRequestTenant? = nil, @comments : String? = nil, @tags : Array(NestedTagRequest)? = nil, @custom_fields : Hash(String, Nil | String | Bool | Int32 | Int64 | Float32 | Float64 | Time)? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if @description.try &.to_s.try &.size.try &.> 200
    ...
    def valid?
      ...
      return false if @description.try &.to_s.try &.size.try &.> 200
