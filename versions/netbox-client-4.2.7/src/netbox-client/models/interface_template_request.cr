...
module NetboxClient
  ...
  class InterfaceTemplateRequest
    ...
    def initialize(@name : String, @_type : String, @device_type : ConsolePortTemplateRequestDeviceType?, @module_type : ConsolePortTemplateRequestModuleType?, @label : String?, @enabled : Bool?, @mgmt_only : Bool?, @description : String?, @bridge : NestedInterfaceTemplateRequest?, @poe_mode : String?, @poe_type : String?, @rf_role : String?)
    end
