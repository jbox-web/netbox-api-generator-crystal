...
module NetboxClient
  ...
  class BriefClusterType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @cluster_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, cluster_count].hash
    end
