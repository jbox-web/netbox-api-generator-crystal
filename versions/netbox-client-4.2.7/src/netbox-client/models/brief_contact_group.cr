...
module NetboxClient
  ...
  class BriefContactGroup
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @contact_count : Int32, @_depth : Int32, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, contact_count, _depth].hash
    end
