...
module NetboxClient
  ...
  class WritablePowerOutletTemplateRequest
    ...
    def initialize(@name : String, @device_type : ConsolePortTemplateRequestDeviceType?, @module_type : ConsolePortTemplateRequestModuleType?, @label : String?, @_type : String?, @power_port : PatchedWritablePowerOutletTemplateRequestPowerPort?, @feed_leg : String?, @description : String?)
    end
