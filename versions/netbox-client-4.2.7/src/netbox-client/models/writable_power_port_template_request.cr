...
module NetboxClient
  ...
  class WritablePowerPortTemplateRequest
    ...
    def initialize(@name : String, @device_type : ConsolePortTemplateRequestDeviceType?, @module_type : ConsolePortTemplateRequestModuleType?, @label : String?, @_type : String?, @maximum_draw : Int32?, @allocated_draw : Int32?, @description : String?)
    end
