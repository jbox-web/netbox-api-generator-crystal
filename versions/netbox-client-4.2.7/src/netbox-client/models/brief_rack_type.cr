...
module NetboxClient
  ...
  class BriefRackType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @manufacturer : BriefManufacturer, @model : String, @slug : String, @description : String?)
    end
    ...
    def hash
      [id, url, display, manufacturer, model, slug, description].hash
    end
