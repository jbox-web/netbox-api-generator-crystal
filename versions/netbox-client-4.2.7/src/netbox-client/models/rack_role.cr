...
module NetboxClient
  ...
  class RackRole
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @slug : String, @created : Time, @last_updated : Time, @rack_count : Int64, @color : String?, @description : String?, @tags : Array(NestedTag)?, @custom_fields : Hash(String, Nil | String | Bool | Int32 | Int64 | Float32 | Float64 | Time)?)
    end
