...
module NetboxClient
  ...
  class BriefVLANGroup
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @vlan_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, vlan_count].hash
    end
