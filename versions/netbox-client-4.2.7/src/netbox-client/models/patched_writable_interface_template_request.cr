...
module NetboxClient
  ...
  class PatchedWritableInterfaceTemplateRequest
    ...
    def initialize(@device_type : ConsolePortTemplateRequestDeviceType?, @module_type : ConsolePortTemplateRequestModuleType?, @name : String?, @label : String?, @_type : String?, @enabled : Bool?, @mgmt_only : Bool?, @description : String?, @bridge : Int32?, @poe_mode : String?, @poe_type : String?, @rf_role : String?)
    end
