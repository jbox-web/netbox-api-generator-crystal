...
module NetboxClient
  ...
  class NestedInterface
    ...
    @[JSON::Field(key: "device", type: NestedDevice, nillable: false, emit_null: false)]
    property device : NestedDevice
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @device : NestedDevice, @name : String, @_occupied : Bool, @cable : Int32?)
    end
    ...
    def hash
      [id, url, display_url, display, device, name, cable, _occupied].hash
    end
