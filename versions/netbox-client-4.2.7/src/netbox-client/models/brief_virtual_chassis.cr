...
module NetboxClient
  ...
  class BriefVirtualChassis
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @member_count : Int32, @master : NestedDevice?, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, master, description, member_count].hash
    end
