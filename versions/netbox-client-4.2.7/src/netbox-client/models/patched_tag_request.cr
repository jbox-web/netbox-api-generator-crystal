...
module NetboxClient
  ...
  class PatchedTagRequest
    ...
    def initialize(@name : String?, @slug : String?, @color : String?, @description : String?, @object_types : Array(String)?)
    end
    ...
    def valid?
      ...
      return false if !@slug.nil? && @slug !~ Regexp.new(/^[-\w]+$/)
    ...
    def hash
      [name, slug, color, description, object_types].hash
    end
