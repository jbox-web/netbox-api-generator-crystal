...
module NetboxClient
  ...
  class NestedVMInterface
    ...
    @[JSON::Field(key: "virtual_machine", type: NestedVirtualMachine, nillable: false, emit_null: false)]
    property virtual_machine : NestedVirtualMachine
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @virtual_machine : NestedVirtualMachine, @name : String)
    end
    ...
    def hash
      [id, url, display_url, display, virtual_machine, name].hash
    end
