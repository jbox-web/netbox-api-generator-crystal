...
module NetboxClient
  ...
  class BriefVirtualCircuitType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @virtual_circuit_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, virtual_circuit_count].hash
    end
