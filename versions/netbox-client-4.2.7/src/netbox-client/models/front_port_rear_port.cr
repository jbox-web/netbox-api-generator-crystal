...
module NetboxClient
  ...
  class FrontPortRearPort
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @label : String?, @description : String?)
    end
    ...
    def hash
      [id, url, display_url, display, name, label, description].hash
    end
