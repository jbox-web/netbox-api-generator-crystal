...
module NetboxClient
  ...
  class BriefTunnelGroup
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @tunnel_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, tunnel_count].hash
    end
