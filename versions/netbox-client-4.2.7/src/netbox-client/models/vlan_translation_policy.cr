...
module NetboxClient
  ...
  class VLANTranslationPolicy
    ...
    @[JSON::Field(key: "rules", type: Array(VLANTranslationRule), nillable: false, emit_null: false)]
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @rules : Array(VLANTranslationRule), @description : String?)
    end
    ...
    def hash
      [id, url, display, name, description, rules].hash
    end
