...
module NetboxClient
  ...
  class BriefLocation
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @rack_count : Int32, @_depth : Int32, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, rack_count, _depth].hash
    end
