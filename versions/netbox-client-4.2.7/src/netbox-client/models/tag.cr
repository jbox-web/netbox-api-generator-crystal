...
module NetboxClient
  ...
  class Tag
    ...
    @[JSON::Field(key: "tagged_items", type: Int64, nillable: false, emit_null: false)]
    property tagged_items : Int64
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @slug : String, @tagged_items : Int64, @created : Time, @last_updated : Time, @color : String?, @description : String?, @object_types : Array(String)?)
    end
    ...
    def valid?
      ...
      return false if @slug !~ Regexp.new(/^[-\w]+$/)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tagged_items == other.tagged_items &&
    ...
    def hash
      [id, url, display_url, display, name, slug, color, description, object_types, tagged_items, created, last_updated].hash
    end
