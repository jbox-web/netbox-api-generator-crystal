...
module NetboxClient
  ...
  class BriefRackRole
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @rack_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, rack_count].hash
    end
