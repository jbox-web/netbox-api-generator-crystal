...
module NetboxClient
  ...
  class BriefRegion
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @site_count : Int32, @_depth : Int32, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, site_count, _depth].hash
    end
