...
module NetboxClient
  ...
  class BriefIPAddress
    ...
    def initialize(@id : Int32, @url : String, @display : String, @family : AggregateFamily, @address : String, @description : String?)
    end
    ...
    def hash
      [id, url, display, family, address, description].hash
    end
