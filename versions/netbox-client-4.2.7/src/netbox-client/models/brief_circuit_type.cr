...
module NetboxClient
  ...
  class BriefCircuitType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @circuit_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, circuit_count].hash
    end
