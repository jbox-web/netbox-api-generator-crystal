...
module NetboxClient
  ...
  class BriefRIR
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @aggregate_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, aggregate_count].hash
    end
