...
module NetboxClient
  ...
  class BriefPlatform
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @device_count : Int64, @virtualmachine_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, device_count, virtualmachine_count].hash
    end
