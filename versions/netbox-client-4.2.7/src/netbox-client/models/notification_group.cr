...
module NetboxClient
  ...
  class NotificationGroup
    ...
    @[JSON::Field(key: "users", type: Array(User)?, nillable: true, emit_null: false)]
    property users : Array(User)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @url : String, @display : String, @display_url : String, @name : String, @description : String?, @groups : Array(Group)?, @users : Array(User)?)
    end
    ...
    def hash
      [id, url, display, display_url, name, description, groups, users].hash
    end
