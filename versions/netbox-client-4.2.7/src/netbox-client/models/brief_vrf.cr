...
module NetboxClient
  ...
  class BriefVRF
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @prefix_count : Int64, @rd : String?, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, rd, description, prefix_count].hash
    end
