...
module NetboxClient
  ...
  class BriefTenantGroup
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @tenant_count : Int32, @_depth : Int32, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, tenant_count, _depth].hash
    end
