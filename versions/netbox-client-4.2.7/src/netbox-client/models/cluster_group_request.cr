...
module NetboxClient
  ...
  class ClusterGroupRequest
    ...
    def initialize(@name : String, @slug : String, @description : String?, @tags : Array(NestedTagRequest)?, @custom_fields : Hash(String, Nil | String | Bool | Int32 | Int64 | Float32 | Float64 | Time)?)
    end
    ...
    def hash
      [name, slug, description, tags, custom_fields].hash
    end
