...
module NetboxClient
  ...
  class BriefModuleType
    ...
    def initialize(@id : Int32, @url : String, @display : String, @manufacturer : BriefManufacturer, @model : String, @description : String?)
    end
    ...
    def hash
      [id, url, display, manufacturer, model, description].hash
    end
