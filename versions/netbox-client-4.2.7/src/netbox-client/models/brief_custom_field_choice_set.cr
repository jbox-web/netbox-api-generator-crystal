...
module NetboxClient
  ...
  class BriefCustomFieldChoiceSet
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @choices_count : String, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, description, choices_count].hash
    end
