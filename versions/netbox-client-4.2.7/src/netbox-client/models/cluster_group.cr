...
module NetboxClient
  ...
  class ClusterGroup
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @slug : String, @created : Time, @last_updated : Time, @cluster_count : Int64, @description : String?, @tags : Array(NestedTag)?, @custom_fields : Hash(String, Nil | String | Bool | Int32 | Int64 | Float32 | Float64 | Time)?)
    end
    ...
    def hash
      [id, url, display_url, display, name, slug, description, tags, custom_fields, created, last_updated, cluster_count].hash
    end
