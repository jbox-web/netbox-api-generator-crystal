...
module NetboxClient
  ...
  class NestedTag
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @slug : String, @color : String?)
    end
    ...
    def hash
      [id, url, display_url, display, name, slug, color].hash
    end
