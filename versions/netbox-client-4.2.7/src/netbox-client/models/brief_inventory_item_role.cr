...
module NetboxClient
  ...
  class BriefInventoryItemRole
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @inventoryitem_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, inventoryitem_count].hash
    end
