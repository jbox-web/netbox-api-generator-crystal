...
module NetboxClient
  ...
  class PatchedWritablePowerOutletTemplateRequest
    ...
    @[JSON::Field(key: "power_port", type: PatchedWritablePowerOutletTemplateRequestPowerPort?, nillable: true, emit_null: false)]
    property power_port : PatchedWritablePowerOutletTemplateRequestPowerPort?
    ...
    def initialize(@device_type : ConsolePortTemplateRequestDeviceType?, @module_type : ConsolePortTemplateRequestModuleType?, @name : String?, @label : String?, @_type : String?, @power_port : PatchedWritablePowerOutletTemplateRequestPowerPort?, @feed_leg : String?, @description : String?)
    end
    ...
    def hash
      [device_type, module_type, name, label, _type, power_port, feed_leg, description].hash
    end
