...
module NetboxClient
  ...
  class BriefPowerPort
    ...
    def initialize(@id : Int32, @url : String, @display : String, @device : BriefDevice, @name : String, @cable : BriefCable, @_occupied : Bool, @description : String?)
    end
    ...
    def hash
      [id, url, display, device, name, description, cable, _occupied].hash
    end
