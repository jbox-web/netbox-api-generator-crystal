...
module NetboxClient
  ...
  class Group
    ...
    @[JSON::Field(key: "user_count", type: Int32, nillable: false, emit_null: false)]
    ...
    def initialize(@id : Int32, @url : String, @display_url : String, @display : String, @name : String, @user_count : Int32, @description : String?, @permissions : Array(ObjectPermission)?)
    end
