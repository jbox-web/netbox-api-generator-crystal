...
module NetboxClient
  ...
  class BriefRole
    ...
    def initialize(@id : Int32, @url : String, @display : String, @name : String, @slug : String, @prefix_count : Int64, @vlan_count : Int64, @description : String?)
    end
    ...
    def hash
      [id, url, display, name, slug, description, prefix_count, vlan_count].hash
    end
