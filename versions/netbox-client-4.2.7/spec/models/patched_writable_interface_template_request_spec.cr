...
# Unit tests for NetboxClient::PatchedWritableInterfaceTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe NetboxClient::PatchedWritableInterfaceTemplateRequest do
  describe "test an instance of PatchedWritableInterfaceTemplateRequest" do
    skip "should create an instance of PatchedWritableInterfaceTemplateRequest" do
      # instance = NetboxClient::PatchedWritableInterfaceTemplateRequest.new
      # expect(instance).to be_instance_of(NetboxClient::PatchedWritableInterfaceTemplateRequest)
    end
  end
