...
# Unit tests for NetboxClient::WritableInterfaceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe NetboxClient::WritableInterfaceRequest do
  describe "test an instance of WritableInterfaceRequest" do
    skip "should create an instance of WritableInterfaceRequest" do
      # instance = NetboxClient::WritableInterfaceRequest.new
      # expect(instance).to be_instance_of(NetboxClient::WritableInterfaceRequest)
    end
  end
