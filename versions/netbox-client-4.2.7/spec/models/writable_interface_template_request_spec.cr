...
# Unit tests for NetboxClient::WritableInterfaceTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe NetboxClient::WritableInterfaceTemplateRequest do
  describe "test an instance of WritableInterfaceTemplateRequest" do
    skip "should create an instance of WritableInterfaceTemplateRequest" do
      # instance = NetboxClient::WritableInterfaceTemplateRequest.new
      # expect(instance).to be_instance_of(NetboxClient::WritableInterfaceTemplateRequest)
    end
  end
