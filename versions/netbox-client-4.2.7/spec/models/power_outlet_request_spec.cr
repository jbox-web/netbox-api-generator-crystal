...
# Unit tests for NetboxClient::PowerOutletRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe NetboxClient::PowerOutletRequest do
  describe "test an instance of PowerOutletRequest" do
    skip "should create an instance of PowerOutletRequest" do
      # instance = NetboxClient::PowerOutletRequest.new
      # expect(instance).to be_instance_of(NetboxClient::PowerOutletRequest)
    end
  end
