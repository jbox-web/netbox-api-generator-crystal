...
# Unit tests for NetboxClient::InterfaceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe NetboxClient::InterfaceRequest do
  describe "test an instance of InterfaceRequest" do
    skip "should create an instance of InterfaceRequest" do
      # instance = NetboxClient::InterfaceRequest.new
      # expect(instance).to be_instance_of(NetboxClient::InterfaceRequest)
    end
  end
